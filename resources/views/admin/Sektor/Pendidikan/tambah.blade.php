                                    ...
                                    <div class="">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-12">
                                                ...
                                                <input class="form-control" name="tanggal_terbit" type="date" value="2018-11-23T10:30:00" id="example-datetime-local-input" onfocus="focused(this)" onfocusout="defocused(this)" required>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-12">
                                                <label>Nomor Izin</label>
                                                <input class="form-control" name="nomor_izin" type="text" onfocus="focused(this)" onfocusout="defocused(this)" required>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-12">
                                                <label>Nama Sekolah</label>
                                                <input class="form-control" name="nama_sekolah" type="text" onfocus="focused(this)" onfocusout="defocused(this)" required>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-12">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-12">
                                                ...
                                                <input class="form-control" name="nama_yayasan" type="text" onfocus="focused(this)" onfocusout="defocused(this)" required>
                                            </div>
                                        </div>
