...
background-color: #c5dffa;"
    ...
    @endif
            ...
            {{-- NSeksi --}}
            <li class="nav-item">
                <a class="nav-link {{ Request::is('NSeksi?id=1') ? 'active' : '' }}"
                    href="{{ url('NSeksi?id=1') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            {{-- NSeksi --}}
            <li class="nav-item">
                <a class="nav-link {{ Request::is('NSeksi?id=3') ? 'active' : '' }}"
                    href="{{ url('NSeksi?id=2') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Perdagangan</h6>
            </li>
            {{-- NSeksi --}}
            <li class="nav-item">
                <a class="nav-link {{ Request::is('NSeksi?id=3') ? 'active' : '' }}"
                    href="{{ url('NSeksi?id=4') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#dataPerdagangan"
                    class="nav-link {{ Route::is('Perdagangan.*') ? 'active' : '' }}" aria-controls="dataPerdagangan"
                    role="button" aria-expanded="false">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                ...
                <div class="collapse  {{ Route::is('Perdagangan.*', 'cariTahunPerdagangan*') ? 'show' : '' }} "
                    id="dataPerdagangan">
                    <ul class="nav ms-4 ps-3">
                        <!-- <li class="nav-item active">
                            <a class="nav-link {{ Route::is('Perdagangan.create') ? 'active' : '' }}"
                                href="{{ route('Perdagangan.create') }}">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Tambah Data </span>
                            </a>
                        </li> -->
                        <li class="nav-item active">
                            <a class="nav-link {{ Route::is('Perdagangan.index', 'cariTahunPerdagangan*') ? 'active' : '' }}"
                                href="{{ route('Perdagangan.index') }}">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Lihat Data </span>
                            </a>
                        </li>
